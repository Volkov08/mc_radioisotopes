...
public class EndLabor extends StructureFeature<StructurePoolFeatureConfig> {

    public EndLabor() {
        // Create the pieces layout of the structure and give it to the game
        super(StructurePoolFeatureConfig.CODEC, EndLabor::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    private static boolean isFeatureChunk(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        return !context.chunkGenerator().method_41053(StructureSetKeys.END_CITIES, context.seed(), chunkpos.x, chunkpos.z, 7);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!EndLabor.isFeatureChunk(context)) {
...
/*        if(structurePiecesGenerator.isPresent()) {
            ...
            ClientMain.LOGGER.log(Level.DEBUG, "Sky Structure at {}", blockpos);
        }
*/
//The last codeblock SHOULD BE IMPLEMENTED; BUT STH IN THE LOGGER ADRESS DOESNT WORK
