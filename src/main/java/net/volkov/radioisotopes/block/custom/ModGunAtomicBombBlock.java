...
public class ModGunAtomicBombBlock extends Block {
    public ModGunAtomicBombBlock(Settings settings) {
        super(settings);
    }
    ...
    private static void primeNuke(World world, BlockPos pos) {
        ...
        NuclearExplosionEntity nuke = new NuclearExplosionEntity(ModEntities.NUCLEAR_EXPLOSION_ENTITY, world, 43, 6000d);
