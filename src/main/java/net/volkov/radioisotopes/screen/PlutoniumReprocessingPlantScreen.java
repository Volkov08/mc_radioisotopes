...
public class PlutoniumReprocessingPlantScreen extends HandledScreen<PlutoniumReprocessingPlantScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(ClientMain.MOD_ID, "textures/gui/plutonium_reprocessing_plant_gui.png");

    public PlutoniumReprocessingPlantScreen(PlutoniumReprocessingPlantScreenHandler handler, PlayerInventory inventory, Text title) {
