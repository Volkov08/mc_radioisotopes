...
public class AtomicReactorControllerScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;

    public AtomicReactorControllerScreenHandler(int syncId, PlayerInventory playerInventory) {
    ...
    public AtomicReactorControllerScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        super(ModScreenHandlers.ATOMIC_REACTOR_CONTROLLER_SCREEN_HANDLER, syncId);
        checkSize(inventory, 3);
        this.inventory = inventory;
        inventory.onOpen(playerInventory.player);
        this.propertyDelegate = delegate;

        this.addSlot(new ModARFuelSlot(inventory, 0, 56, 53));
